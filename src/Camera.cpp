...
Camera::Camera()
    : Camera(1.0, 100, 10, 10, 90, {}, Vec3(0, 0, -1), Vec3(0, 1, 0), 0, 10) {}
...
Camera::Camera(double aspect_ratio, int img_w, int samples_per_pixel, int max_depth,
    ...
    : m_aspect_ratio{aspect_ratio}, m_pixel_samples_scale{}, m_vertical_fov{vertical_fov},
      ...
      m_w{}, m_v{}, m_u{}, m_defocus_disk_u{}, m_defocus_disk_v{} {
    initialise();
}
...
void Camera::initialise() {
    ...
    auto viewport_h{2 * h * m_focus_dist};
    ...
    auto viewport_upper_left{m_center - (m_focus_dist * m_w) - viewport_u / 2 -
                             viewport_v / 2};
